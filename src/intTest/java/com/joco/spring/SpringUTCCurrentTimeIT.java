...
public class SpringUTCCurrentTimeIT extends SpringBootITBase {
  @Autowired
  private DummyTimeUserClass dummyTimeUserClass;

  @Test
  @Order(1)
  @DisplayName("Class level annotation with UTC timezone should set the time properly")
  public void testClassLevelAnnotationForUTC() {
    // GIVEN
    var expectedLocalDateTime = LocalDate.of(2022, 11, 5).atTime(LocalTime.of(0, 0));
  ...
  @Test
  @Order(2)
  @DisplayName("Method level annotation with UTC timezone should set the time properly")
  @CurrentTime(datePattern = "2021-12-15", timePattern = "05:30", zoneId = "UTC")
  public void testMethodLevelAnnotationForUTC() {
    // GIVEN
    var expectedLocalDateTime = LocalDate.of(2021, 12, 15).atTime(LocalTime.of(5, 30));
  ...
  @Test
  @Order(3)
  @DisplayName("Class level annotation with UTC timezone should set the time properly after method level annotation was used on another test")
  public void testClassLevelAnnotationForUTCAfterMethodLevelAnnotationWasUsed() {
    // GIVEN
    var expectedLocalDateTime = LocalDate.of(2022, 11, 5).atTime(LocalTime.of(0, 0));
    var expectedZonedDateTime = ZonedDateTime.parse("2022-11-05T00:00Z[UTC]");
    var expectedOffsetDateTime = OffsetDateTime.parse("2022-11-05T00:00Z");
